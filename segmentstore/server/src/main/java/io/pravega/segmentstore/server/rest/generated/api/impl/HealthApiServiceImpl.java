package io.pravega.segmentstore.server.rest.generated.api.impl;
...
public class HealthApiServiceImpl extends HealthApiService {
    ...
    @Override
    public Response getContributorReadiness(String id, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response getContributorStatus(String id, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
